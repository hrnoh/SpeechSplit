...
targetDir_f0 = '/hd0/speechsplit/original_preprocessed/raptf0'
targetDir = '/hd0/speechsplit/original_preprocessed/spmel'
...
for subdir in sorted(subdirList):
    ...
    for fileName in sorted(fileList):
        ...
        assert fs == 22050     # librosa로 불러오면 fs=22050, sf로 불러오면 fs=44100
        if x.shape[0] % 256 == 0:
